        ...
        <article className="prose mx-auto w-full max-w-3xl px-4 py-16 sm:px-6 sm:py-24">
          ...
          <div className="mt-8 space-y-6 text-sm leading-7 text-foreground/90">
            <Section title="1. Administrator danych">
              Administratorem danych osóbowych jest wybitnastrona.pl. Kontakt:{" "}
            ...
            <Section title="2. Jakie dane przetwarzamy">
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Tresc promptow i wygenerowane pliki - do dzialania usługi.</li>
            ...
            <Section title="3. Cele i podstawa prawna">
              ...
              swiadczenie usługi - oraz uzasadnionego interesu (lit. f) -
            ...
            <Section title="6. Cookies">
              Uzywamy ciasteczek niezbednych do dzialania usługi (sesja Supabase)
