...
-- ============================================================
-- Tabela project_admins (light-auth dla wygenerowanych paneli)
-- Migracja 0045 — używana przez /api/projects/[id]/create-admin
-- w trybie shared (gdy projekt nie ma podpiętej zewnętrznej bazy).
-- ============================================================
